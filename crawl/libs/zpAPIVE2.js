...
let apis = {
    UPCOMING: 'fc=6&m_accType=MY&SystemLanguage=vi-VN&TimeFilter=' + service.nextDayInSing(1, 'YYYYMMDD') + '000000&m_gameType=S_&m_SortByTime=0&m_LeagueList=&SingleDouble=double&clientTime=&c=A&fav=&exlist=0&keywords=&m_sp=0'
};
console.log(service.nextDayInSing(1, 'YYYYMMDD'));
let cacheData = null;
let services = {
